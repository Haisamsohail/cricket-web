<footer class="bg-light">
    <div class="container pb-13 pb-md-15">
      ...
      @include('shared.joinuurcommunity');
      @include('shared.clientslogos');
      ...
      <div class="row gy-6 gy-lg-0">
        <div class="col-md-4 col-lg-3">
          <div class="widget">
            ...
            <p class="mb-4">© 2024 CricClubs. <br class="d-none d-lg-block" />All rights reserved.</p>
  ...
  <script src="{{ URL::asset('public/assets/js/theme.js') }}"></script>
</body>
<!-- {{ URL::asset('public/assets/img/favicon.png') }} -->
</html>