        ...
        <div class="container py-14 py-md-16">
            <div class="row mb-3">
                <div class="col-md-10 col-xl-9 col-xxl-7 mx-auto text-center">
                    <img src="{{ URL::asset('public/assets/img/icons/lineal/team.svg')}}"
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <img class="rounded-circle w-15 mb-4"
                                                src="{{ URL::asset('public/assets/img/avatars/te1.jpg')}}"
                            ...
                            <div class="swiper-slide">
                                <div class="item-inner">
                                    <div class="card">
                                        <div class="card-body">
                                            <img class="rounded-circle w-15 mb-4"
                                                src="{{ URL::asset('public/assets/img/avatars/te2.jpg')}}"
                            ...
                            <div class="swiper-slide">
                                <div class="item-inner">
                                    <div class="card">
                                        <div class="card-body">
                                            <img class="rounded-circle w-15 mb-4"
                                                src="{{ URL::asset('public/assets/img/avatars/te3.jpg')}}"
                            ...
                            <div class="swiper-slide">
                                <div class="item-inner">
                                    <div class="card">
                                        <div class="card-body">
                                            <img class="rounded-circle w-15 mb-4"
                                                src="{{ URL::asset('public/assets/img/avatars/te4.jpg')}}"
                            ...
                            <div class="swiper-slide">
                                <div class="item-inner">
                                    <div class="card">
                                        <div class="card-body">
                                            <img class="rounded-circle w-15 mb-4"
                                                src="{{ URL::asset('public/assets/img/avatars/te5.jpg')}}"
                            ...
                            <div class="swiper-slide">
                                <div class="item-inner">
                                    <div class="card">
                                        <div class="card-body">
                                            <img class="rounded-circle w-15 mb-4"
                                                src="{{ URL::asset('public/assets/img/avatars/te6.jpg')}}"
